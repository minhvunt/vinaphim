...
class td_api_single_template extends td_api_base {
     ...
     * @return bool
     */
    static function _is_tdb_template($single_template_id) {
        if (substr($single_template_id, 0, 4 ) == 'tdb_') {
            return true;
        }
     ...
     * @return int
     */
    static function _tdb_get_template_id($single_template_id) {
        return (int) str_replace('tdb_template_', '', $single_template_id);
    }
