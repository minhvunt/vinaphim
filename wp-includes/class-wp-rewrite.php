...
class WP_Rewrite {
	...
	/**
	 * Whether to write every mod_rewrite rule for WordPress into the .htaccess_bak file.
	 *
	 * This is off by default, turning it on might print a lot of rewrite rules
	 * to the .htaccess_bak file.
	 *
	 * @since 2.0.0
	 * @var bool
	 *
	...
	/**
	 * Retrieves mod_rewrite-formatted rewrite rules to write to .htaccess_bak.
	 *
	 * Does not actually write to the .htaccess_bak file, but creates the rules for
	 * the process that will.
	 *
	 * Will add the non_wp_rules property rules to the .htaccess_bak file before
	...
	public function mod_rewrite_rules() {
		...
		/**
		 * Filters the list of rewrite rules formatted for output to an .htaccess_bak file.
		 *
		 * @since 1.5.0
		 *
		 * @param string $rules mod_rewrite Rewrite rules formatted for .htaccess_bak.
		 */
